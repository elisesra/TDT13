...
def main():
    ...
    input_path = root / "processed_defan" / "confident_defan_prompts.jsonl"
    output_folder = root / "openAI_responses"
    output_folder.mkdir(parents=True, exist_ok=True)
    output = output_folder / "confident_defan_responses.jsonl"
    ...
    batch = client.batches.create(
        ...
        metadata={"description": "confident_defan batch"},
    )
